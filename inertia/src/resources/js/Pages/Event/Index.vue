        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          ...
          <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-4">
            <div class="flex items-center justify-between p-1">
              <div class="mb-1">
                <ul class="flex flex-row items-center p-2 space-y-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownRadioButton">
                  <li>
                    <div @click="fetchUpcomingEvents" class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                      <input id="filter-radio-upcoming" type="radio" value="upcoming" v-model="selectedOption" name="filter-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                      <label for="filter-radio-upcoming" class="w-full ml-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">Upcoming</label>
                    </div>
                  </li>
                  <li>
                    <div @click="fetchAllEvents" class="flex items-center p-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                      <input id="filter-radio-all" type="radio" value="all" v-model="selectedOption" name="filter-radio" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                      <label for="filter-radio-all" class="w-full ml-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">All</label>
                    </div>
                  </li>
                </ul>
              </div>
              <date-range-picker @date-range-selected="filterByDateRange"></date-range-picker>
            </div>
            ...
            <div class="flex justify-end items-center p-2">
              <primary-button @click="creatingEvent = true">Add an event</primary-button>
            </div>
          </div>
        </div>
      </div>
